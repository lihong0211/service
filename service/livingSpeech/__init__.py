# service/livingSpeech/__init__.py
"""
生活用语服务模块 - 使用ORM
"""
from flask import request, jsonify
from app.app import db
from model.living_speech_model import LivingSpeech
...
def list_speeches():
    ...
    try:
        ...
        # 获取分页数据
        offset = (page - 1) * size
        speeches = LivingSpeech.builder_query(criterion).offset(offset).limit(size).all()
