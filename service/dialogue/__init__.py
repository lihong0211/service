...
from model.dialogue_model import Dialogue
...
def add():
    ...
    try:
        dialogue_str = json.dumps(dialogue_data, ensure_ascii=False) if dialogue_data else None
